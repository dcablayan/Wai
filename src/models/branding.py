...
WAVE_MODELS: List[ModelBrand] = [
    ...
    ModelBrand(
        ...
        english_name="Steady Wave",
        display_name="ʻAle Kūpaʻa (Steady Wave)",
        category="pipeline",
        role="Naive last-value baseline and stability floor",
        description="Naive baseline: predict the last observed value for all future steps.",
        order=6,
    ),
    ModelBrand(
